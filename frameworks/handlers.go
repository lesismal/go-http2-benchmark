...
// BodyPool holds the buffers the net/http based servers read a request body
// into before echoing it, sized by -b, so that echoing a body costs no
// allocation of its own in any of them.
